(function(){
    ...
    .service('Category',['$http',function($http){
        ...
        this.getAll = function(success,failure){
            //$http.get('http://bookmarks-angular.herokuapp.com/api/categories/:id')
            $http.get('/24-7/model/proy2_grillas_restful/cliente.php/listaGrupos/1')
                .success(success)
                .error(failure);
        }
    }])
    ...
    .factory('Bookmark',['$resource',function($resource){
        ...
        return $resource('/24-7/model/proy2_grillas_restful/cliente.php/listarOpciones/1',{
            id : '@id'
        },{
            update : {method:'PUT'}
        });
    ...
    .controller('MainController',['$scope','Category','Bookmark',function($scope,Category,Bookmark){
        ...
        Category.getAll(function(data){
            ...
            //$scope.currentCategory = data.grupo;
