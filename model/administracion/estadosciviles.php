...
$slim_app->get('/listaEstadosCiviles','listaEstadosCiviles');
...
function listaEstadosCiviles() {
	$sql = "SELECT id_estado_civil,estado_civil,_registrado,_modificado,_id_usuario,_estado
